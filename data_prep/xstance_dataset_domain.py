...
def get_datasets_target(train_file_path,
    ...
    for t in all_targets_list:
        train_dataset_each_target = XStanceDataset_target('train', None, train_file_path, t, tokenizer, 0, max_seq_len)
        valid_dataset_each_target = XStanceDataset_target('valid', None, valid_file_path, t, tokenizer, 0, max_seq_len)
        test_dataset_each_target = XStanceDataset_target('test', 'new_comments_defr', test_file_path, t, tokenizer, 0, max_seq_len)
...
if __name__ == "__main__":
    ...
    # dataset_list = get_datasets_target(train_file_path, valid_file_path, test_file_path, tokenizer, num_train_lines, max_seq_len)
    # sum = 0
